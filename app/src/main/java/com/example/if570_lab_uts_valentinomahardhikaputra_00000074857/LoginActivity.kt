...
import com.example.if570_lab_uts_valentinomahardhikaputra_00000074857.databinding.ActivityLoginBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val clickableSpan = object : ClickableSpan() {
            ...
            override fun updateDrawState(ds: TextPaint) {
                ...
                ds.color = getColor(R.color.purple)  // Set "Register" text to green
        ...
        auth.signInWithEmailAndPassword(email, password)
            .addOnCompleteListener(this){
                if (it.isSuccessful){
                    ...
                    val intent = Intent(this, MainActivity::class.java) // Change to the next activity
                    startActivity(intent)
                } else {
